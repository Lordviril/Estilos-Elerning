...
- (id)initWithView:(UIView *)view {
	...
	if (!view) {
		[NSException raise:[NSString stringWithString:@"mbprogresshudiewisnillexception"] 
					format:[NSString stringWithFormat:@"%@",@"the view used in the mbprogresshud initializer is nil."]];
	}
