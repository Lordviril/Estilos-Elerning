...
- (void) setupEnglishNames
{
  ...
  _monthNames = [[NSArray alloc] initWithObjects:[eEducationAppDelegate getLocalvalue:@"January"],[eEducationAppDelegate getLocalvalue:@"February"],[eEducationAppDelegate getLocalvalue:@"March"], [eEducationAppDelegate getLocalvalue:@"April"],[eEducationAppDelegate getLocalvalue:@"May"], [eEducationAppDelegate getLocalvalue:@"June"], [eEducationAppDelegate getLocalvalue:@"July"],[eEducationAppDelegate getLocalvalue:@"August"],[eEducationAppDelegate getLocalvalue:@"September"], [eEducationAppDelegate getLocalvalue:@"October"], [eEducationAppDelegate getLocalvalue:@"November"], [eEducationAppDelegate getLocalvalue:@"December"], nil];
}
