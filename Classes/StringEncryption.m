...
{
	StringEncryption *crypto = [[[StringEncryption alloc] init] autorelease];
	// Removed below and replaced it with the one below it due to comments in the forum to solve a bug.
	// http://dotmac.rationalmind.net/2009/02/aes-interoperability-between-net-and-iphone/#comment-1264
...
//    NSLog(@"pkcs7: %d", *pkcs7);
   ...
   /*
     see http://dotmac.rationalmind.net/2009/02/aes-interoperability-between-net-and-iphone/#comment-1262 for reason for commenting
     and http://dotmac.rationalmind.net/2009/02/aes-interoperability-between-net-and-iphone/#comment-10851
